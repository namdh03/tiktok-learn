...
import { search as searchServices } from '~/assets/apiServices/searchServices';
...
function Search() {
    ...
    return (
        // Tippy warning: Using a wrapper <div> or <span> tag around the reference element solves this by creating a new parentNode context.
        <div>
            <HeadlessTippy
                interactive
